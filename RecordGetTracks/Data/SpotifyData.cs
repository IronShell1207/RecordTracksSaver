...
namespace SpotifyData
{
    ...
    public class SpotifyPatches
    {
        ...
        public static By CookieAllertContainer = By.XPath("//div[@class='ot-sdk-container']");
        public static By CookieAllertCloser = By.XPath("//div[@id='onetrust-close-btn-container']");
        public static By Playlists = By.XPath("//ul/div"); // поиск всех плейлистов. Взять плейлист через свойство href //a[@href='/playlist/#id плейлста#'] !!! БЕРЕТ ТОЛЬКО ЦЕЛЕКОМ
        #region создание плейлиста
        public static By NewPlstBtn = By.XPath("/html[1]/body[1]/div[4]/div[1]/div[2]/nav[1]/div[1]/div[2]/div[1]/div[1]/button[1]"); //кнопка добавления плейлиста НАДЕЖНАЯ СТОПРОЦЕНТОВ 10.9/21
        public static By ChangePlaylistName = By.XPath("/html[1]/body[1]/div[4]/div[1]/div[2]/div[3]/main[1]/div[2]/div[2]/div[1]/div[1]/div[2]/section[1]/div[1]/div[5]/span[1]/button[1]/span[1]/h1[1]"); // НАЗВАНИЕ ПЛЕЙЛИСТА В ПЛЕЙЛИСТЕ БОЛЬШИМИ БУКВАМИ КЛИК

        public static By NewPlstDefName = By.XPath("//button[@type='button']//h1[@as='h1']"); // и прямо по нему левой кнопкой для меню 

        public static By PlaylistList = By.XPath("/html[1]/body[1]/div[4]/div[1]/div[2]/nav[1]/div[1]/div[2]/div[1]/div[4]/div[4]/div[1]/div[1]/ul[1]/div[1]/div[2]/li"); // + /li[#] СПИСОК ПЛЕЙЛИСТОВ СЛЕВА В главном окне

        // public static By NewPlstEditD = By.XPath("//div[@id='context-menu-root']/ul[1]/li[4]/button[1]"); // edit details btn in context menu
        public static By NewPlstFieldName = By.XPath("//input[@data-testid='playlist-edit-details-name-input']"); //works 10.9.21
       ...
       // public static By SongsLikeOnly = By.XPath("//div[@data-testid='tracklist-row'][1]//button[@title='Save to Your Library']"); // сохранить песню в лайканые песни
        ...
        public static string AddToPlBtn ="/html[1]/body[1]/div[{0}]/div[1]/ul/li[7]"; //add to playlist 10.9.21
        public static By AlreadyAdded = By.XPath("//body/div[6]/div[1]");
        public static By AlreadyAddedNOTTOADD = By.XPath("//body/div[6]/div[1]/div[1]/div[1]/div[1]/button[2]"); // НЕ ДОБАВЛЯТЬ
        ...
        public static string PlaylstsList = "/html[1]/body[1]/div[{0}]/div[1]/ul/li[7]/div[1]/ul/li"; //"//body/div[@id='tippy-1']/div[@id='context-menu-root']/ul[1]/li[6]/div[1]/ul[1]/li"; // список плейлистов +[{0}] для выбора нужного
